...
export const UnifiedThemeSettings: React.FC = () => {
  ...
  const colorGroups = {
    ...
    'Foreground Colors': ['fgColor-primary', 'fgColor-secondary', 'fgColor-muted', 'fgColor-active', 'fgColor-hover', 'fgColor-accent', 'fgColor-danger'],
  };
        ...
        <>
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              <h4 className="text-sm font-medium text-fgColor-primary">Customize Your Theme</h4>
