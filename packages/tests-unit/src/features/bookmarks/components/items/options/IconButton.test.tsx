...
describe('IconButton', () => {
  ...
  it('renders without crashing', () => {
    const onClick = vi.fn();
    render(<IconButton onClick={onClick} icon={<span>icon</span>} dataTestId="test-button" />);
  ...
  it('renders with custom className', () => {
    const onClick = vi.fn();
    render(<IconButton onClick={onClick} icon={<span>icon</span>} className="custom-class" dataTestId="test-button" />);
  ...
  it('renders with custom class names', () => {
    const onClick = vi.fn();
    render(<IconButton onClick={onClick} icon={<span>icon</span>} className="bg-red-500 text-white" dataTestId="test-button" />);
  ...
  it('renders the icon', () => {
    const onClick = vi.fn();
    render(<IconButton onClick={onClick} icon={<span data-testid="icon">icon</span>} dataTestId="test-button" />);
  ...
  it('forwards ref correctly', () => {
    const ref = vi.fn();
    render(<IconButton ref={ref} icon={<span>icon</span>} dataTestId="test-button" />);
