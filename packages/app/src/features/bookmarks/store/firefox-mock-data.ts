import type { FirefoxBookmarks } from '@/features/bookmarks/lib/browser/api/firefox-api';
...
// Helper function to create bookmark items as raw Firefox BookmarkTreeNode
const createBookmark = (id: string, parentId: string, title: string, url: string): FirefoxBookmarks => ({
  id,
  parentId,
  title,
  url,
...
// Helper function to create folder items as raw Firefox BookmarkTreeNode
const createFolder = (
  id: string,
  parentId: string,
  title: string,
  children: FirefoxBookmarks[] = []
): FirefoxBookmarks => ({
  id,
  parentId,
  title,
...
/**
 * Firefox mock data with Firefox-style IDs:
 * - 'root________' = Root
 ...
 */
export const firefoxMockData: FirefoxBookmarks[] = [
  {
    id: FIREFOX_BUILT_IN_IDS.ROOT,
    title: '',
    dateAdded: Date.now(),
    children: [
      // Bookmarks Menu (id: 'menu________')
      createFolder(FIREFOX_BUILT_IN_IDS.MENU, FIREFOX_BUILT_IN_IDS.ROOT, 'Bookmarks Menu', [
        // Deep nesting test
        createFolder('10', FIREFOX_BUILT_IN_IDS.MENU, '📚 Long Title Folder with Special Characters !@#$%^&*()', [
        ...
        createFolder('15', FIREFOX_BUILT_IN_IDS.MENU, 'Mixed Content', [
        ...
        createFolder('19', FIREFOX_BUILT_IN_IDS.MENU, 'Empty Folder at Root Level', []),

        // Development Resources - Large folder
        createFolder('32', FIREFOX_BUILT_IN_IDS.MENU, '💾 Development Resources', [
        ...
        createFolder('100', FIREFOX_BUILT_IN_IDS.MENU, '🚀 Programming Languages', [
        ...
        createFolder('200', FIREFOX_BUILT_IN_IDS.MENU, '🎨 Design & UI', [
        ...
        // Learning & Courses
        createFolder('300', FIREFOX_BUILT_IN_IDS.MENU, '📖 Learning & Courses', [
        ...
        // Tools & Productivity
        createFolder('400', FIREFOX_BUILT_IN_IDS.MENU, '⚙️ Tools & Productivity', [
        ...
        // News & Media
        createFolder('500', FIREFOX_BUILT_IN_IDS.MENU, '📰 News & Media', [
        ...
        // Entertainment
        createFolder('600', FIREFOX_BUILT_IN_IDS.MENU, '🎬 Entertainment', [
        ...
        // Personal & Social
        createFolder('700', FIREFOX_BUILT_IN_IDS.MENU, '👤 Personal & Social', [
        ...
        createFolder('800', FIREFOX_BUILT_IN_IDS.MENU, '📚 Very Large Folder (50+ items)', [
        ...
        createFolder('900', FIREFOX_BUILT_IN_IDS.MENU, '🔗 Deep Nesting Test', [
        ...
        // Edge cases folder
        createFolder('1000', FIREFOX_BUILT_IN_IDS.MENU, '⚠️ Edge Cases', [
          createBookmark(
            '1001',
            '1000',
        ...
        createFolder('1100', FIREFOX_BUILT_IN_IDS.MENU, '📁 Empty Folders Group', [
      ...
      // Bookmarks Toolbar (id: 'toolbar_____')
      createFolder(FIREFOX_BUILT_IN_IDS.TOOLBAR, FIREFOX_BUILT_IN_IDS.ROOT, 'Bookmarks Toolbar', [
        createBookmark('61', FIREFOX_BUILT_IN_IDS.TOOLBAR, 'Gmail', 'https://gmail.com'),
        createBookmark('62', FIREFOX_BUILT_IN_IDS.TOOLBAR, 'Calendar', 'https://calendar.google.com'),
        createBookmark('63', FIREFOX_BUILT_IN_IDS.TOOLBAR, 'Google Drive', 'https://drive.google.com'),
        createBookmark('64', FIREFOX_BUILT_IN_IDS.TOOLBAR, 'Keep', 'https://keep.google.com'),
      ]),

      // Other Bookmarks (id: 'unfiled_____')
      createFolder(FIREFOX_BUILT_IN_IDS.UNFILED, FIREFOX_BUILT_IN_IDS.ROOT, 'Other Bookmarks', [
        createBookmark('21', FIREFOX_BUILT_IN_IDS.UNFILED, 'Duplicate ID Bookmark', 'https://duplicate.example.com/'),
        createFolder('40', FIREFOX_BUILT_IN_IDS.UNFILED, '⚙️ Tools & Utilities', [
        ...
        createFolder('46', FIREFOX_BUILT_IN_IDS.UNFILED, '🎨 Design Inspiration', [
          createBookmark('47', '46', 'Dribbble', 'https://dribbble.com'),
          createBookmark('48', '46', 'Behance', 'https://www.behance.net/'),
        ]),
        createFolder('49', FIREFOX_BUILT_IN_IDS.UNFILED, '📦 Package Managers', [
        ...
        createFolder('1200', FIREFOX_BUILT_IN_IDS.UNFILED, '🌍 International Sites', [
      ...
      createBookmark('70', FIREFOX_BUILT_IN_IDS.ROOT, 'Loose Bookmark 1', 'https://example1.com'),
      createBookmark('71', FIREFOX_BUILT_IN_IDS.ROOT, 'Loose Bookmark 2', 'https://example2.com'),
      createBookmark('72', FIREFOX_BUILT_IN_IDS.ROOT, 'Loose Bookmark 3', 'https://example3.com'),
      createBookmark('73', FIREFOX_BUILT_IN_IDS.ROOT, 'Loose Bookmark 4', 'https://example4.com'),
      createBookmark('74', FIREFOX_BUILT_IN_IDS.ROOT, 'Loose Bookmark 5', 'https://example5.com'),
    ],
  },
];
