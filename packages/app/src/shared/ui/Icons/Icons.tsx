...
export const GearIcon = ({ dataTestId, size = 'sm', className = '' }: IconProps) => {
...
export const CrossIcon = ({ dataTestId, size = 'sm', className = '' }: IconProps) => {
  const sizeClassName = getSizeClassName(size);
...
export const FolderIcon = ({ dataTestId, size = 'sm', className = '' }: IconProps) => {
  const sizeClassName = getSizeClassName(size);
...
export const HeartIcon = ({ dataTestId, size = 'sm', className = '' }: IconProps) => {
  const sizeClassName = getSizeClassName(size);
...
export const CheckIcon = ({ dataTestId, size = 'sm', className = '' }: IconProps) => {
  const sizeClassName = getSizeClassName(size);
...
export const ListIcon = ({ dataTestId, size = 'sm', className = '' }: IconProps) => {
  const sizeClassName = getSizeClassName(size);
...
export const GridIcon = ({ dataTestId, size = 'sm', className = '' }: IconProps) => {
  const sizeClassName = getSizeClassName(size);
